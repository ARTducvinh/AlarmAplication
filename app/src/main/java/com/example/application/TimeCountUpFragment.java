...
public class TimeCountUpFragment extends Fragment {
    ...
    public void onStart() {
        ...
        if(overStep){
            ...
            if(code == -1 && currentTimeCountUp != 0 && tempSec != 0){
                ...
                Type type = new TypeToken<ArrayList<MilestonesItem>>(){}.getType();
    ...
    public void resetCountTimeUp(){
        ...
        //
        oldHour="00";oldMinutes="00";oldSecs="00";oldSecs="00";
        hourCurr="00";minutesCurr="00";secondCurr="00";secsCurr="00";
        order = 0;milestonesAdapter.clearAllItems();
        SharedPreferences sharedPreferences = context.getSharedPreferences("metadata_time_count_up", MODE_PRIVATE);
    ...
    public String timeUpGetText(){return textViewTimeCountUp.getText().toString();}


    //TRẢ VỀ TRẠNG THÁI ĐANG CHẠY HAY DỪNG
    public boolean getIsStartCountUp(){return this.startCountTimeUp;}
    public void setStartCountTimeUp(boolean bool){this.startCountTimeUp = bool;}
    ...
    public void takeMilestones(){
        ...
        if(order == 0){
            ...
            oldHour = hourCurr; oldMinutes = minutesCurr ; oldSeconds = secondCurr; oldSecs = secsCurr;
    ...
    public void setOldTime(String hour,String minutes,String  seconds,String secs){
        oldHour = hourCurr;oldMinutes = minutesCurr;oldSeconds = seconds;oldSecs = secs;
    }
}